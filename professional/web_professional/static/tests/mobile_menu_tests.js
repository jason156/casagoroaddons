odoo.define('web_professional.mobile_menu_tests', function (require) {
"use strict";

var Menu = require('web_professional.Menu');
var testUtils = require('web.test_utils');
var testUtilsEnterprise = require('web_professional.test_utils');
var UserMenu = require('web.UserMenu');

QUnit.module('web_professional mobile_menu_tests', {
    afterEach() {
