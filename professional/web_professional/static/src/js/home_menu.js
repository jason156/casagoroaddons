odoo.define('web_professional.HomeMenu', function (require) {
"use strict";
        ...
        utils.traversePath(menuData, function (menuItem, parents) {
            ...
            if (!menuItem.parent_id) {
                if (menuItem.web_icon_data) {
                    ...
                    item.web_icon_data = '/web_professional/static/src/img/default_icon_app.png';
                }
            } else {
...
odoo.define('web_professional.ExpirationPanel', function (require) {
"use strict";
...
HomeMenu.include({
    ...
    _enterpriseExpirationCheck: function () {
        ...
        var dbexpirationDate = new moment(session.expiration_date || new moment().add(3650, 'd'));
