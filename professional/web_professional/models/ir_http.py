...
class Http(models.AbstractModel):
    ...
    def session_info(self):
        ...
        result['warning'] = warn_enterprise
        #result['expiration_date'] = ICP.get_param('database.expiration_date')
        result['expiration_date'] = '2030-10-10'#ICP.get_param('database.expiration_date')
        #result['expiration_date'] = '2021-04-26'#ICP.get_param('database.expiration_date')
        result['expiration_reason'] = ICP.get_param('database.expiration_reason')
        return result
