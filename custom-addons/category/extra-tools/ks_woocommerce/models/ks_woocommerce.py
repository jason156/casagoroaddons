...
class KsWooCommerceInstance(models.Model):
    ...
    def create(self, values):
        ...
        res.ks_woo_pricelist = self.env['product.pricelist'].create({'name': res.ks_name + ' Pricelist',
                                                                     'company_id': res.ks_company.id})
    ...
    def write(self, values):
        ...
        if values.get('ks_woo_currency'):
            if self.ks_woo_pricelist:
                self.ks_woo_pricelist.currency_id = values.get('ks_woo_currency')
                self.ks_woo_pricelist.ks_instance_id = self.id
